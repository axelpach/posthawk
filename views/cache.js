...
exports["dialogs/table_switcher"] = function template(pug, locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"views\u002Fdialogs\u002Ftable_switcher.jade":".table-switcher-container\n  input.search-input(type=\"text\" placeholder=\"Search tables...\" autofocus)\n  ul.results-list\n"};
var pug_indent = [];
;pug_debug_line = 1;pug_debug_filename = "views\u002Fdialogs\u002Ftable_switcher.jade";
pug_html = pug_html + "\n\u003Cdiv class=\"table-switcher-container\"\u003E";
;pug_debug_line = 2;pug_debug_filename = "views\u002Fdialogs\u002Ftable_switcher.jade";
pug_html = pug_html + "\n  \u003Cinput class=\"search-input\" type=\"text\" placeholder=\"Search tables...\" autofocus=\"autofocus\"\u002F\u003E";
;pug_debug_line = 3;pug_debug_filename = "views\u002Fdialogs\u002Ftable_switcher.jade";
pug_html = pug_html + "\n  \u003Cul class=\"results-list\"\u003E\u003C\u002Ful\u003E\n\u003C\u002Fdiv\u003E";} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;};
exports["dialogs/table_switcher"].content = ".table-switcher-container\n  input.search-input(type=\"text\" placeholder=\"Search tables...\" autofocus)\n  ul.results-list\n";
...
pug_html = pug_html + (null == (pug_interp = link_to("Show tunnel optiolds", '#', {exec: 'showExtraLogingFields', class: 'open-extra-fields'})) ? "" : pug_interp);
;pug_debug_line = 37;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (null == (pug_interp = link_to("Hide tunnel optiolds", '#', {exec: 'showExtraLogingFields', class: 'close-extra-fields'})) ? "" : pug_interp) + "\n            \u003C\u002Flabel\u003E\n          \u003C\u002Fp\u003E";
...
;pug_debug_line = 64;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cinput name=\"query\" type=\"hidden\"\u002F\u003E";
;pug_debug_line = 66;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cp class=\"buttons\"\u003E";
;pug_debug_line = 67;pug_debug_filename = "views\u002Flogin_screen.jade";
...
;pug_debug_line = 71;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n      \u003Cform class=\"middle-window-content postgres-url\"\u003E";
;pug_debug_line = 72;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Ctextarea" + (" class=\"connection-url\""+" name=\"connect_url\""+pug.attr("placeholder", `postgres://${process.env.USER || 'user'}@localhost/${process.env.USER || 'dbname'}`, true, false)) + "\u003E";
;pug_debug_line = 73;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (pug.escape(null == (pug_interp = `postgres://${process.env.USER || 'user'}@localhost/${process.env.USER || 'dbname'}`) ? "" : pug_interp)) + "\u003C\u002Ftextarea\u003E";
;pug_debug_line = 75;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cdiv class=\"ssh-tunnel-info\"\u003E";
;pug_debug_line = 76;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (pug.escape(null == (pug_interp = "SHH Tunnel") ? "" : pug_interp));
;pug_debug_line = 77;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\u003Csmall class=\"help-icon\" data-tooltip=\"Example:\n postgres:\u002F\u002Fremote.com? ssh_host=remote.com &amp;ssh_user=optional &amp;ssh_pass=optional &amp;ssh_port=optional &amp;ssh_key=optional\"\u003E";
;pug_debug_line = 77;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "?\u003C\u002Fsmall\u003E\n        \u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\n          \u003Clabel\u003E\u003C\u002Flabel\u003E";
;pug_debug_line = 81;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Clabel\u003E";
...
pug_html = pug_html + "\n        \u003Cp class=\"buttons\"\u003E";
;pug_debug_line = 86;pug_debug_filename = "views\u002Flogin_screen.jade";
...
pug_html = pug_html + "\n          \u003Cinput class=\"native-look\" type=\"submit\" value=\"Connect\" autofocus=\"autofocus\"\u002F\u003E\n        \u003C\u002Fp\u003E\n      \u003C\u002Fform\u003E";
;pug_debug_line = 90;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n      \u003Cdiv class=\"middle-window-content heroku-1\"\u003E";
;pug_debug_line = 91;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Ch5\u003E";
;pug_debug_line = 91;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Connect to Heroku PostgreSQL\u003C\u002Fh5\u003E";
;pug_debug_line = 93;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cp\u003E";
;pug_debug_line = 93;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + (null == (pug_interp = link_to("Access with OAuth", '#', {exec: 'startHerokuOAuth'})) ? "" : pug_interp) + "\u003C\u002Fp\u003E";
;pug_debug_line = 94;pug_debug_filename = "views\u002Flogin_screen.jade";
//p!= link_to('Access with "$ heroku" command line tool', '#')
pug_html = pug_html + "\n      \u003C\u002Fdiv\u003E";
;pug_debug_line = 97;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n      \u003Cdiv class=\"middle-window-content heroku-oauth\"\u003E";
;pug_debug_line = 98;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cul class=\"steps\"\u003E";
;pug_debug_line = 99;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli class=\"access-token\"\u003E";
;pug_debug_line = 99;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Grand access\u003C\u002Fli\u003E";
;pug_debug_line = 100;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli class=\"request-token\"\u003E";
;pug_debug_line = 100;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Request Token\u003C\u002Fli\u003E";
;pug_debug_line = 101;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli class=\"get-apps\"\u003E";
;pug_debug_line = 101;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Get applications list\u003C\u002Fli\u003E\n        \u003C\u002Ful\u003E";
;pug_debug_line = 102;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cul class=\"apps\"\u003E\u003C\u002Ful\u003E";
;pug_debug_line = 103;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cul class=\"steps\"\u003E";
;pug_debug_line = 104;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli class=\"database-url\"\u003E";
;pug_debug_line = 104;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Database URL\u003C\u002Fli\u003E";
;pug_debug_line = 105;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli class=\"connect-db\"\u003E";
;pug_debug_line = 105;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Connect to DB\u003C\u002Fli\u003E\n        \u003C\u002Ful\u003E\n      \u003C\u002Fdiv\u003E";
;pug_debug_line = 107;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n      \u003Cdiv class=\"middle-window-content heroku-cl\"\u003E";
;pug_debug_line = 108;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n        \u003Cul\u003E";
;pug_debug_line = 109;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli\u003E";
;pug_debug_line = 109;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Detect command line utilite\u003C\u002Fli\u003E";
;pug_debug_line = 110;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "\n          \u003Cli\u003E";
;pug_debug_line = 110;pug_debug_filename = "views\u002Flogin_screen.jade";
pug_html = pug_html + "Get applications list\u003C\u002Fli\u003E\n        \u003C\u002Ful\u003E\n      \u003C\u002Fdiv\u003E\n    \u003C\u002Fdiv\u003E\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fdiv\u003E";
